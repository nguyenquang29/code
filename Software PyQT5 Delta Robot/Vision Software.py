...
class VideoCaptureThread(QThread):
        ...
        def __init__(self, plc, parent=None):
            ...
            self.roi_width = 0.5
            self.roi_height = 0.5
            self.contour_threshold = 54000  # Default value
        ...
        def run(self):
            ...
            while self._run_flag:
                ...
                if grabResult.GrabSucceeded():
                    ...
                    _, mask = cv2.threshold(roi_frame, self.lower_threshold, self.upper_threshold, cv2.THRESH_BINARY)
                    ...
                    bytes_per_line = ch * w
                    qt_image = QImage(frame.data, width, height, width, QImage.Format_Grayscale8)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.uic.lbImage.setFixedSize(600, 500)
